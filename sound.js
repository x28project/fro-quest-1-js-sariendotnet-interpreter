...
var Sound =
{
  ...
  play: function(n, flag)
  {
    ...
    if (this.sndN
    &&  document.contains(this.sndN)) {
      this.sndNFlag = flag;
      this.flagsToSet[flag] = 9007199254740992;
      this.sndN.onended = function() { Sound.flagsToSet[Sound.sndNFlag] = 1; Sound.sndN = null; Sound.sndNFlag = null; };
      this.sndN.play();
      if (this.playClickDone == false
      &&  this.playClick == false
      &&  (this.sndN.paused
      ||   (this.sndN.buffered.length > 0
      &&    this.sndN.buffered.end(0) === 0))) {
        this.playClick = true;
        this.playClickN = n;
