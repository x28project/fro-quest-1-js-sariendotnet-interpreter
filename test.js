...
var Test = {
  ...
  cycle: function () {
    ...
    if (Test.playing) {
      ...
      while (!isNaN(actionCycle) && actionCycle == Test.current_cycle) {
        if (!Test.current_cycle_commands) Test.current_cycle_commands = {};
  ...
  processCycleCommands: function () {
    ...
    if (c) {
      if (c.k) Test.playKeyPress(c.k);
      if (c.d) Test.playDirection(c.d);
      if (c.a) Test.playAction(c.a);
    }
  },
